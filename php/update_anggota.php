        ...
        <form action="" method="post">
          <div class="box1">
            ...
            <div class="input">
              ...
              <input type="text" name="alamat" placeholder="Alamat" id="Alamat" required value="<?= $updt["alamat"]; ?>" />
            </div>
            <div class="input">
              <label for="Kelas">Kelas</label>
              <input type="text" name="kelas" placeholder="Kelas" id="Kelas" required value="<?= $updt["kelas"]; ?>" />
            </div>
            <div class="input">
              <label for="Email">Email</label>
              <input type="text" name="email" placeholder="Email" id="Email" required value="<?= $updt["email"]; ?>" />
            </div>
            <div class="input">
